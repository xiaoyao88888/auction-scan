...
3. 主线共振:该股 themes 里至少有一个词精确命中「当日资金主线TOP5板块名(theme_intraday_capital 的 themeName 字段前5名,逐字比对)」或「涨停题材排行TOP3(primaryThemeStats 前3个 theme 字段,逐字比对)」;命中与否必须在输出中逐条列出核对结果
